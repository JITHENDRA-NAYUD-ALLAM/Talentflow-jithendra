      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {stages.map((stage) => (
          <div key={stage.id} className={`rounded-lg border-2 ${stage.color} p-4`}>
            <h3 className="font-semibold text-black mb-4">{stage.title}</h3>
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex items-center space-x-2 flex-1 min-w-0">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    <h4 className="font-medium text-sm truncate text-black">{candidate.name}</h4>
                                    <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                                      <Mail className="h-3 w-3 text-gray-800 flex-shrink-0" />
                                      <span className="truncate text-gray-800">{candidate.email}</span>
                                    </div>
                                  </div>
                                </div>
                                <Button
